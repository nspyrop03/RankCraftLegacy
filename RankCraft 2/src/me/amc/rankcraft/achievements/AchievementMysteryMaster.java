...
public class AchievementMysteryMaster extends Achievement {

	private HashMap<String, Integer> p = new HashMap<>();
	private HashMap<String, Boolean> c = new HashMap<>();
	
	public AchievementMysteryMaster(String name, int points, Reward r) {
		super(name, Achievement.Type.Special);
		this.setSpecialPoints(points);
		this.setReward(r);
	//	this.setSpecialMission("§eUnlock "+ChatColor.DARK_PURPLE+"Mysterious §eClass.");
		this.setSpecialMission(MainCore.instance.guiLang.getAchievementMysterious());
	}
